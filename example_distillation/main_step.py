...
data = csv.reader(open('replay_sim.csv', 'rb'))
replay = []
for row in data:
	replay.append(row)
...
apm_option(server,app,'x[1].tau',4.0)
...
apm_option(server,app,'x[32].tau',4.0)
apm_option(server,app,'x[32].status',1)
apm_option(server,app,'x[32].fstatus',0)

# Manipulated variables (u)
apm_option(server,app,'rr.upper',5)
apm_option(server,app,'rr.dmax',0.2)
apm_option(server,app,'rr.lower',1)
apm_option(server,app,'rr.status',0)
apm_option(server,app,'rr.fstatus',1)

apm_option(server,app,'fbot.upper',1)
apm_option(server,app,'fbot.dmax',0.2)
apm_option(server,app,'fbot.lower',0)
apm_option(server,app,'fbot.status',0)
apm_option(server,app,'fbot.fstatus',1)
